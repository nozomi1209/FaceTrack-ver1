...
namespace FaceTracking3D
{
    ...
    public partial class MainWindow : Window
    {
        ...
        {            
            ...
            {
                sw.WriteLine("windows start");       //wiriting text to existing file WTF.txt.
            }
            //===============================================================//   
        ...
        private void SensorChooserOnKinectChanged(object sender, KinectChangedEventArgs kinectChangedEventArgs)
        {
            ...
            if (oldSensor == null || newSensor == null)
            {
                ...
                using (StreamWriter sw = new StreamWriter(@"C:\Users\Public\WTF.txt", true))
                {
                    sw.WriteLine("oldSensor == null || newSensor == null");
                }
                //===============================================================// 
            }
            ...
            if (oldSensor != null)
            {
                using (StreamWriter sw = new StreamWriter(@"C:\Users\Public\WTF.txt", true))
                {
                    sw.WriteLine("OldSensor != null yoooo");
                }
            ...
            if (newSensor != null)
            {
                ...
                using (StreamWriter sw = new StreamWriter(@"C:\Users\Public\WTF.txt", true))
                {
                    sw.WriteLine("NewSensor != null yoooo");
                }
